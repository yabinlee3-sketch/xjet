...
```bash
# every framework module keeps version 2.0.4 (see root build)
git init
git add .
...
Open `https://jitpack.io/#<your-org>/xjet/2.0.4` and click *Get it*.
...
dependencies {
    implementation("com.github.<your-org>.xjet:xjet-core:2.0.4")
    implementation("com.github.<your-org>.xjet:xjet-room:2.0.4")
    implementation("com.github.<your-org>.xjet:xjet-ui-compose:2.0.4")
    // KSP annotation processor
    ksp("com.github.<your-org>.xjet:xjet-processor:2.0.4")
}
```
